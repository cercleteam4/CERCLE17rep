...
namespace cercle17
{
    public partial class frmEmpr05_CUADRE : Form
    {
        int ColSelect = 11;
        int c_Partida = 0;
        int c_AñoP = 1;
        ...
        private void Seguridad()
        {
            switch (frmPpal.USUARIO)
            {
                ...
                case "4":       //Botella'
                    ...
                    break;
                case "5":       //DIALPESCA
                    this.Text = "Cuadre del día " + GloblaVar.VERSION;
                    break;
                case "6":       //ABT
                    this.Text = "Cuadre del día " + GloblaVar.VERSION;
                    break;
        ...
        private void frmEmpr05_CUADRE_Load(object sender, EventArgs e)
        {
            string gIdent = this.GetType().FullName + " " + System.Reflection.MethodBase.GetCurrentMethod().Name + " ";
        ...
        //Será un método para cuadrar o descuadrar una fila determinada
        {
            ...
            try
            {
                ...
                {//Cuadrar la partida
                    ...
                    sQ += " AND ";
                    sQ += "AlmMay=" + Almacen;
                    GloblaVar.gUTIL.ATraza("Cuadrando Partida " + Partida + "/" + AñoPartida + " a Fecha " + dtpFecha.Value.ToShortDateString());
                ...
                {//Descuadrar la partida
                    ...
                    sQ += " AND ";
                    sQ += "AlmMay='" + Almacen + "'";
                    GloblaVar.gUTIL.ATraza("DESCuadrando Partida " + Partida + "/" + AñoPartida );
                }
        ...
        {
            string gIdent = this.GetType().FullName + " " + System.Reflection.MethodBase.GetCurrentMethod().Name + " ";
            GloblaVar.gUTIL.ATraza(gIdent + "Marcando partidas con menos de 1 Kg de stock ");
            try
            {
        ...
        private void button_Si_Cuadre_Partida_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Funciones.EjecutaNonQuery(sQ, GloblaVar.gConRem);
                GloblaVar.gUTIL.ATraza(gIdent + "Cuadrada Partida " + lPartida.Text + "/" + lAño.Text );
                lPartida.Text = lAño.Text = lStockInicial.Text = lStock.Text = lAlmacen.Text = lArtCod.Text = lProCod.Text = lProNom.Text = LArtDes.Text = tObservaciones.Text = "";
                Carga_dG1();
            ...
            if (dG1.Columns[e.ColumnIndex].HeaderText == "CUADRADO")
            {
                ...
                else
                {
                    string mensaje = string.Format("Evento CellContentClick.\n\nSe va adejar como NO CUADRADA la , \nPartida: '{0}', \nAño: '{1}', \nStock: '{2}'",
                                                        ...
                                                        row.Cells["Año"].Value,
                                                        row.Cells["Stock"].Value);
                    GloblaVar.gUTIL.ATraza(gIdent + mensaje);
        ...
        {
            string gIdent = this.GetType().FullName + " " + System.Reflection.MethodBase.GetCurrentMethod().Name + " ";
            GloblaVar.gUTIL.ATraza(gIdent +"Listar CUADRE del dia");
            try
            {
