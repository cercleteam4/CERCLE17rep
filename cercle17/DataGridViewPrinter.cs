...
class DataGridViewPrinter
{
    ...
    private void DrawHeader(Graphics g)
    {
        ...
        {
            PageNumber++;
            string PageString = "Pág. " + PageNumber.ToString();
    ...
    public bool DrawDataGridView(Graphics g)
    {
        ...
        {
            MessageBox.Show("Falló el listado: " + ex.Message.ToString(), Application.ProductName + " - Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            return false;
        }
    }
}
