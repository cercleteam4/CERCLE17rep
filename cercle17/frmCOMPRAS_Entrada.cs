...
namespace cercle17
{
    public partial class frmCOMPRAS_Entrada : Form
    {
        ...
        private void limpiarDetalleLinea()
        {
            ...
            cbPais.Text = "ESPAÑA";
            tbPExpedidor2.Text = "";
            lCondEsps.Text = "CONSERVAR ENTRE 0-4º";
            ...
            dtpFDesembarco.Value = DateTime.Now;
            dtpFElaboracion.Value = DateTime.Now;
            tbFElaboracion.Text = string.Empty;
            dtpFCaducidad.Value = DateTime.Now;           
        ...
        private void cargarDatosArticulo(string artCod)
        {
            ...
            if(resp == "")
            {
                ...
                {
                    lCondEsps.Text = articulo.AnomCongel;
                }                    
            }
            else
            {
        ...
        private void tbProCod_TextChanged(object sender, EventArgs e)
        {
